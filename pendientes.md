...
Aprender el nuevo lenguaje y visitar otros humanos
...
Una mujer con una grave enfermedad de la piel (epidermólisis bullosa). Tiene el cuerpo completamente vendado, incluyendo el rostro y la cabeza, solo visibles los ojos y la boca. No tiene cabello. No tiene orejas. Le faltan todos los dedos de la mano izquierda y el pie izquierdo. Amputada de la mano derecha a nivel del codo por cáncer. No puede estirar completamente los pies, permanecen en una posición de 90 grados, con poca movilidad. No puede estirar la mano, la muñeca permanece en una posición cerca de los 90 grados, también con poco grado de movimiento. Tiene pene, amputado a la mitad de la longitud. Pene y testículos también vendados. Usa silla de ruedas eléctrica. Para la primera cita, usa una sonda para orinar, no tiene incontinencia, pero no puede ir al baño por si misma.
...
Le pido a una amiga que me enyese. Ella vive con su hija de 19 años. Nos conocemos desde la universidad. Hicimos yesos en la época de la universidad, pero nos alejamos cuando se casó. Ahora está divorciada.
...
**Relación con Mark:** Sin historia aún. Personaje creado; pendiente de introducción.

**Conocimiento:** Sin historia aún.

**Voz / Tics de habla:**

- **S → F**: toda /s/, /z/ y /c/ ante e/i → /f/: "foy" (soy), "efpo" (esto), "yof" (los), "vef" (vez). En **CC** ante e/i, la primera C (/k/) se mantiene y la segunda (/s/) → F: "acfidempe" (accidente), "imfecfióm" (infección), "acfióm" (acción).
- **T → P**: toda /t/ → /p/: "pambiém" (también), "payeg" (taller), "pemía" (tenía).
- **L → Y**: toda /l/ → /y/: "ya" (la), "ey" (el), "yo" (lo), "yevo" (llevo).
- **N → M**: toda /n/ → /m/: "mo" (no), "em" (en), "uma" (una), "pambiém" (también).
- **R, RR → G**: toda /r/ y /rr/ → /g/: "pog" (por), "piegma" (pierna), "degecha" (derecha), "payeg" (taller).
- Combinadas: "efpe" (este), "momempo" (momento), "fempí" (sentí), "macimiempo" (nacimiento).
- Frase de apertura defensiva cuando alguien la mira demasiado: "Mo foy um momfpguo."
...
**Citas memorables:** _(ninguna aún)_

**Momentos con Mark:** _(ninguno aún)_
